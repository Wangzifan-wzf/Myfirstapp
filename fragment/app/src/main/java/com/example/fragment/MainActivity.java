...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        //初始化一个 fragment
        fragment_1 fragment = new fragment_1(); //实例化 fragment
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            case R.id.bt_one:
                fragmentTransaction.replace(R.id.fragment_id,new fragment_1());  //加载第一个 fragment
                fragmentTransaction.addToBackStack(null);  //把 fragment one放到 栈队里  跳转后 返回键可返回
                break;
            case R.id.bt_two:
                fragmentTransaction.replace(R.id.fragment_id,new fragment_2());  //加载第二个 fragment
    ...
    private class fragment_1 extends Fragment {
    }
}